...
const RULES: Array<[EventType, RegExp]> = [
  ...
  ["workshop", /\b(workshops?|class(es)?\b|seminar|tutorial|how to|hands-on|cooking class|art class|language lessons?|spanish lessons?|french lessons?|mentorship)\b/i],
  ...
  ["fitness", /\b(yoga|fitness|runs?\b|race\b|hikes?\b|walks?\b|workout|pilates|tai chi|meditation|zumba|barre|spin class|cycling|pickleball|tennis tournament|golf tournament|campout)\b/i],
  ["sale", /\b(yard sale|plant sale|bake sale|fundraiser|book sale|tag sale|garage sale|craft fair|holiday market|donations?|recycling event|rummage sale)\b/i],
  ["community", /\b(town hall|volunteer|cleanup|clean-up|meeting\b|forum|civic|pride|memorial day|veterans|town meeting|trivia|bingo|game night|worship|sunday service|sabbath|study group|conversational|conversation club|french club|spanish club|open house|drop[- ]in|social group|senior center|celebrates|celebration|community supper|community)\b/i],
];
